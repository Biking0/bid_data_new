...
delete_time = time.time() - 3600 * 24 * config.day_180

path_list = ['/var/log/hadoop-yarn/ocdp/', '/var/log/hadoop/ocdp', '/var/log/hbase', '/var/log/ambari-infra-solr',
             '/home/ocdp/hbase-indexer-1.6.1.0/logs', '/home/ocdp/ocsearch/server/logs']
