...
# 修改日期：
# ***************************************************************************
# 程序调用格式：python ocdp_check_hive_table.py
# ***************************************************************************
...
class CheckData():
    ...
    def read_table_name(self):
        ...
        while True:
            ...
            get_task_sql = "select id,table_name,partition_type,partition_time  from tb_copy_data_log where sy_count is not null and  remark4 is null and start_time >'2020-08-13 10:00:51' and copy_status='2' and (%s is  NULL or %s ='')  limit 500;" % (
                self.count_col, self.count_col)
            ...
            update_status_list=[]
            update_sql = "update tb_copy_data_log  set remark4='checked' "
            in_condition = ''
