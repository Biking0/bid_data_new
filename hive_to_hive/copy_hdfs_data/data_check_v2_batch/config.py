...
# ocdp_hive_sh = "beeline -u 'jdbc:hive2://172.19.40.241:10000/csap' -n ocdp -p 1q2w1q@W  --showHeader=false --outputformat=dsv --delimiterForDSV=$'\t' -e '"

# 新库mr引擎
ocdp_hive_sh = "beeline -u 'jdbc:hive2://172.19.168.53:10000/csap' -n ocdp -p 1q2w1q@W  --showHeader=false --outputformat=dsv --delimiterForDSV=$'\t' -e '"
