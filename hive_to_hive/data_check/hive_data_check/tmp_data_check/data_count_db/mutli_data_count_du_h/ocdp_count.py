...
# 修改日期：
# ***************************************************************************
# 程序调用格式：nohup python ocdp_count.py >> nohup.out_ocdp &
# ***************************************************************************
...
def get_part_list(table_name, size_list_result):
    ...
    get_part_sql = "select part_name from tb_tmp_check_data where table_name='%s' and ocdp_count is null " % (table_name)
