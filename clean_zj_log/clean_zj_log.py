...
source_path_list = ['/data/javaAppLogs/zx_execute', '/home/ocdp/javaApp/zj_execute_tomcat7/logs',
                    '/home/ocdp/javaApp/zj_interface_apache-tomcat-7.0.73/logs',
                    '/home/ocdp/javaApp/zx_core_tomcat/logs']
# target_path_list=['/home/ocdp/hyn/clean_file/test/test2']
target_path_list = ['/hdfs/data04/javaAppLogs/zx_execute', '/hdfs/data04/javaAppLogs/zx_execute',
                    '/hdfs/data04/javaAppLogs/zj_interface', '/hdfs/data04/javaAppLogs/zx_core']
    ...
    try:
        ...
        for file in os.listdir(source_path_list[i]):
            ...
            if os.path.getmtime(filename) < move_time:
                ...
                print time.strftime('%Y-%m-%d %H:%M:%S', time.localtime()), filename + " is moved  to ", \
                target_path_list[i]
